    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $fetch_accounts['name']; ?> <?= $fetch_accounts['father']; ?> <?= $fetch_accounts['surname']; ?></td>
                <td><?= $fetch_accounts['std']; ?></td>
                <td><?= $fetch_accounts['total_fees']; ?></td>
                <td><?= $fetch_accounts['pay']; ?></td>
                <td><?= $fetch_accounts['pay']; ?></td>
                <td><?= $fetch_accounts['pcontact']; ?></td>
                <td><a href="fees_info.php?student_id=<?= $fetch_accounts['student_id'] ?>"><button>View</button></a></td>
            </tr>
            <?php
                }
            } else {
