...
$update_admin + $conn->prepare("UPDATE `student_details` SET name=?, father=?, surname=?, gender=?, DOB=?, contact=?, pcontact=?, address=?, std=?, pay=?, total_fees=?, email=? WHERE Student_id = ?");
$update_admin->execute([$name, $father, $surname, $gender, $dob, $contact, $pcontact, $address, $std, $pay, $total_fees, $email,$student_id]);
...
<form action="" method="post" >
  ...
  <div class="form-group fullname">
    ...
    <input type="text" id="fullname" value="<?= $fetch_accounts['name']; ?>"   required>
  </div>
  <div class="form-group fathername">
    <label for="fathername">Father Name<span>*</span></label>
    <input type="text" id="fathername" value="<?= $fetch_accounts['father']; ?>" required>
  </div>

  <div class="form-group surname">
    <label for="surname">Surname Name<span>*</span></label>
    <input type="text" id="surname" value="<?= $fetch_accounts['surname']; ?>" required>
  </div>
  ...
  <div class="form-group DOB">
    ...
    <input type="date" id="DOB" value="<?= $fetch_accounts['DOB']; ?>" required>
  </div>

  <div class="form-group contact number">
    <label for="contact number">contact number<span></span></label>
    <input type="text" maxlength="10"  pattern="\d*" id="contact number" value="<?= $fetch_accounts['contact']; ?>" >
  </div>


  <div class="form-group parentno">
    <label for="parentno"> parent contact number<span>*</span></label>
    <input type="text" id="parentno" maxlength="10"  pattern="\d*" value="<?= $fetch_accounts['pcontact']; ?>" required>
  </div>
  ...
  <div class="form-group address">
    ...
    <input type="text" id="address" value="<?= $fetch_accounts['address']; ?>" required>
  </div>
  ...
  <!-- <div class="form-group surname">
    ...
    <input type="text" id="surname" value="Enter your surname" required>
  </div> -->
  ...
  <div class="form-group email">
    ...
    <input type="text" id="email" value="<?= $fetch_accounts['email']; ?>" >
  </div>
  
  <div class="form-group totalfees">
    <label for="totalfees">total fees <span>*</span></label>
    <input type="text" id="totalfees" value="<?= $fetch_accounts['total_fees']; ?>" required>
  </div>

  <div class="form-group pay_fees">
    <label for="pay_fees">pay_fees <span>*</span></label>
    <input type="text" id="pay_fees" value="<?= $fetch_accounts['pay']; ?>" required>
  </div>
